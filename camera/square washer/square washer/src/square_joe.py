...
OUTPUT_FILE = "../data/measured_output.csv"
...
# =====================================================
def draw_detection(display, result, x1, y1, mm_per_px):
    ...
    if result['type'] in ['square_washer', 'square']:
        ...
        # Create semi-transparent dark background for text readability
        ...
        for r in results:
            for box in r.boxes:
                ...
                if shape_result:
                    ...
                    draw_detection(display, shape_result, x1, y1, mm_per_px)
                    ...
                    if shape_type in ['square_washer', 'square']:
                        ...
                        with open(OUTPUT_FILE, "a", newline='') as f:
                            csv.writer(f).writerow([
                                ...
                                x1, y1, x2, y2, FIXED_DISTANCE_MM, shape_result['confidence']
                            ])
        
        # Display info
        cv2.putText(display, f"Distance: {FIXED_DISTANCE_MM}mm | Scale: {mm_per_px:.4f}mm/px",
