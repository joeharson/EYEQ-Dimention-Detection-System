...
- Accurate dimensional measurement (OD / ID / Width / Height)
- DXF / CAD reference-based calibration
- Interactive frontend dashboard
- Backend API for inspection logic
...
Smart manufacturing POCs
AI-based quality control demos
